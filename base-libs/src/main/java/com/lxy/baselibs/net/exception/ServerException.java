package com.lxy.baselibs.net.exception;
...
public class ServerException extends Exception {
    ...
    public static ServerException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex.message = StringUtils.getString(R.string.net_con_error);
            return ex;
            ...
            ex.message = StringUtils.getString(R.string.null_error);
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new ServerException(e, ERROR.SSL_ERROR);
            ex.message = StringUtils.getString(R.string.cer_error);
            return ex;
        } else if (e instanceof ClassCastException) {
            ex = new ServerException(e, ERROR.CAST_ERROR);
            ex.message = StringUtils.getString(R.string.type_error) + e.getMessage();
            return ex;
            ...
            ex.message = StringUtils.getString(R.string.prase_error) + e.getMessage();
            return ex;
            ...
            ex.message = StringUtils.getString(R.string.error);
            return ex;
        }
    }
