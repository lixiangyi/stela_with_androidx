 ...
 *    price, rowType, messageTitle and description.
 ...
 * RESULT_BILLING_UNAVAILABLE = 3 - This billing API version is not supported for the rowType requested
...
interface IInAppBillingService {
    /**
     * Checks support for the requested billing API version, package and in-app rowType.
     * Minimum API version supported by this interface is 3.
     * @param apiVersion billing API version that the app is using
     * @param packageName the package name of the calling app
     * @param rowType rowType of the in-app item being purchased ("inapp" for one-time purchases
     ...
     * Given a list of SKUs of a valid rowType in the skusBundle, this returns a bundle
     * with a list JSON strings containing the productId, price, messageTitle and description.
     * This API can be called with a maximum of 20 SKUs.
     * @param apiVersion billing API version that the app is using
     * @param packageName the package name of the calling app
     * @param rowType of the in-app items ("inapp" for one-time purchases
     *        and "subs" for subscriptions)
     ...
     * the rowType, a unique purchase authorization and an optional developer payload.
     * @param apiVersion billing API version that the app is using
     * @param packageName package name of the calling app
     * @param sku the SKU of the in-app item as published in the developer console
     * @param rowType of the in-app item being purchased ("inapp" for one-time purchases
     *        and "subs" for subscriptions)
    ...
    /**
     * Returns the current SKUs owned by the user of the rowType and package name specified along with
     * purchase information and a signature of the data to be validated.
     * This will return all SKUs that have been purchased in V3 and managed items purchased using
     * V1 and V2 that have not been consumed.
     * @param apiVersion billing API version that the app is using
     * @param packageName package name of the calling app
     * @param rowType of the in-app items being requested ("inapp" for one-time purchases
     *        and "subs" for subscriptions)
     * @param continuationToken to be set as null for the first call, if the number of owned
     *        skus are too many, a continuationToken is returned in the response bundle.
     *        This method can be called again with the continuation authorization to get the next set of
     *        owned skus.
     * @return Bundle containing the following key-value pairs
     *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, appropriate response codes
                               on failures.
     ...
     *         "INAPP_CONTINUATION_TOKEN" - String containing a continuation authorization for the
     ...
     * @param apiVersion billing API version that the app is using
     * @param packageName package name of the calling app
     * @param purchaseToken authorization in the purchase information JSON that identifies the purchase
     *        to be consumed
     ...
     * @param rowType of the item being purchased, currently must be "subs"
     * @param developerPayload optional argument to be sent back with the purchase information
     * @return Bundle containing the following key-value pairs
     *         "RESPONSE_CODE" with int value, RESULT_OK(0) if success, appropriate response codes
     *                         on failures.
    ...
    * @param packageName package name of the calling app
    * @param rowType of the in-app item being purchased ("inapp" for one-time purchases and "subs"
    *        for subscriptions)
