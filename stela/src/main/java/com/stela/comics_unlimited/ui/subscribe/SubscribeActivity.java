...
public class SubscribeActivity extends BaseMvpActivity<SubscribePresenter> implements SubscribeContract.View, GoogleSubscribeHelper.GoogleSubsInventoryInterface,
...
//                DataStore.getEmail8(this,PICK_ACCOUNT_REQUEST);
                ...
                if (!mCannotSubs) {
                    GoogleSubscribeHelper.doPay(SubscribeActivity.this, mInventory, mSubscriptionEntitys, mSelectedSubscriptionPeriod);
