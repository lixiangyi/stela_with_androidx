...
public class LoginModel extends BaseModel implements LoginContract.Model {
    ...
    @Override
    public Observable<BaseHttpResult<PersonEntity>> login(String email, String password, String model, String os,
                                                          String version, String appVersion, String buildnumber,  String notificationToken, String pushEnabled) {
        return RetrofitUtils.getHttpService().login(email,password,model,os,version,appVersion,buildnumber,notificationToken,pushEnabled);
    }
    @Override
