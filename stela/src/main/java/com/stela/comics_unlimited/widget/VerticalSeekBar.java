        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (mIsDragging) {
                    ...
                    // should
                    // be interpreted as a tap-seek to that locationValue.
                    onStartTrackingTouch();
                    trackTouchEvent(event);
                    onStopTrackingTouch();
...
//        }
        ...
        progress += scale * max;
        Log.i("lixiangyi", "y: "+y);
        Log.i("lixiangyi", "height: "+height);
        Log.i("lixiangyi", "bottom: "+bottom);
        Log.i("lixiangyi", "top: "+top);
        Log.i("lixiangyi", "available: "+available);
        Log.i("lixiangyi", "scale: "+progress);
        Log.i("lixiangyi", "max: "+max);
        Log.i("lixiangyi", "mTouchProgressOffset: "+mTouchProgressOffset);
        Log.i("lixiangyi", "progress: "+progress);
        Log.i("lixiangyi", "-----------------------------------");
