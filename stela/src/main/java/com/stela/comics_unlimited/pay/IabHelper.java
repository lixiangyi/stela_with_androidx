...
public class IabHelper {
    ...
    // The item rowType of the current purchase flow
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            logDebug("Constructing buy intent for " + sku + ", item rowType: " + itemType);
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            logDebug("Expected item rowType: " + mPurchasingItemType);
...
//                logDebug("Purchase signature successfully verified.");
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        if (!itemInfo.mItemType.equals(ITEM_TYPE_INAPP)) {
            throw new IabException(IABHELPER_INVALID_CONSUMPTION,
                    "Items of rowType '" + itemInfo.mItemType + "' can't be consumed.");
        }
        ...
        try {
            ...
            if (token == null || token.equals("")) {
                logError("Can't consume " + sku + ". No authorization.");
                throw new IabException(IABHELPER_MISSING_TOKEN, "PurchaseInfo is missing authorization for sku: "
                        + sku + " " + itemInfo);
            }

            logDebug("Consuming sku: " + sku + ", authorization: " + token);
    ...
    void checkSetupDone(String operation) {
        if (!mSetupDone) {
            ...
            // TODO: 2019/7/16 去掉carsh   (未安装google)
//            throw new IllegalStateException("IAB helper is not set up. Can't perform operation: " + operation);
    ...
    int getResponseCodeFromBundle(Bundle b) {
        ...
        if (o == null) {
            ...
            logError("Unexpected rowType for bundle response code.");
            logError(o.getClass().getName());
            throw new RuntimeException("Unexpected rowType for bundle response code: " + o.getClass().getName());
        }
    }
    ...
    int getResponseCodeFromIntent(Intent i) {
        ...
        if (o == null) {
            ...
            logError("Unexpected rowType for intent response code.");
            logError(o.getClass().getName());
            throw new RuntimeException("Unexpected rowType for intent response code: " + o.getClass().getName());
        }
    }
    ...
    int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        // Query purchases
        logDebug("Querying owned items, item rowType: " + itemType);
        logDebug("Package name: " + mContext.getPackageName());
        boolean verificationFailed = false;
        String continueToken = null;

        do {
            logDebug("Calling getPurchases with continuation authorization: " + continueToken);
...
//                if (Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
                    ...
                    if (TextUtils.isEmpty(purchase.getToken())) {
                        logWarn("BUG: empty/null authorization!");
                        logDebug("Purchase data: " + purchaseData);
                    }

                    // Record ownership and authorization
...
//                }
            ...
            logDebug("Continuation authorization: " + continueToken);
